<?php
    ...
    // Membuat objek dari kelas Reports dan memanggil metode tampilData untuk mengambil data laporan
    $reports = new Reports();
    $hasil = $reports->tampilData();
?>
...
<h5 class="student-view">Lihat sebagai <a href="reports_student.php">student/mahasiswa</a></h5> <!-- Menyediakan link untuk melihat laporan sebagai mahasiswa -->
<table class="table" id="Table">
  <thead>
    <tr>
      <th scope="col">No</th> <!-- Kolom untuk nomor urut -->
      <th scope="col">ID REPORT</th> <!-- Kolom untuk menampilkan ID Laporan -->
...
<tbody>
  ...
  ?>
    <tr>
        ...
        <td><?=$row['id_report'] ?></td> <!-- Menampilkan ID Laporan -->
